  ...
  return (
    <header className="relative z-50 flex justify-between items-center p-4 bg-white shadow-md">
      ...
      >
        ...
        <NavLink to="/dashboard" className="block px-4 py-2 rounded hover:bg-blue-600">Thống kê</NavLink>
        <NavLink to="/dashboard/bookings" className="block px-4 py-2 rounded hover:bg-blue-600">Đặt sân</NavLink>
